...
# uWire
Компактная обёртка на AVR TWI (I2C) с Arduino Wire-подобным API
...
## Использование
### Инициализация
Объявлен глобальный объект `uWire`.
...
<a id="install"></a>
## Установка
- Библиотеку можно найти по названию **uWire** и установить через менеджер библиотек в:
    - Arduino IDE
    - Arduino IDE v2
    - PlatformIO
- [Скачать библиотеку](https://github.com/GyverLibs/uWire/archive/refs/heads/main.zip) .zip архивом для ручной установки:
